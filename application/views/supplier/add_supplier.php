<div class="clearfix"></div>
        <div class="row">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                <br />
                <form action="<?= site_url('supplier/add_supplier') ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="name" value="<?= set_value('name') ?>" id="first-name" class="form-control col-md-7 col-xs-12">
                            <?= form_error('name'); ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" name="alamat" rows="3"><?= set_value('alamat') ?></textarea>
                    <?= form_error('alamat'); ?>
                    </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="middle-name" class="form-control col-md-7 col-xs-12" type="email" name="email" value="<?= set_value('email') ?>">
                        <?= form_error('email'); ?>
                    </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="phone" value="<?= set_value('phone') ?>" class="date-picker form-control col-md-7 col-xs-12" type="number">
                        <?= form_error('phone'); ?>
                    </div>
                    </div>
                    <div class="form-group">
