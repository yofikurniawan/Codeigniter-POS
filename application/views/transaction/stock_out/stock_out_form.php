<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Add Stock Out<small></small></h2>
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-offset-4">
                        ...
                        <div class="form-group">        
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group input-group">
                                <input type="text" name="info" class="form-control"  placeholder="Rusak / Etc">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                                <a href="<?php echo base_url('stock/out') ?>" class="btn btn-primary" >Back</a>
                                <button class="btn btn-primary" type="reset">Reset</button>
                                <button type="submit" name="out_add" class="btn btn-success">Submit</button>
                        </div>
                        </form>
                    </div>    
                </div>
